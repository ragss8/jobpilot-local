  ...
  for (const r of floor.rooms) {
    ...
    if (
      ...
      if (
        ...
        plant(x, z, 0.85);
        obstacles.push({ x: x - 0.55, z: z - 0.55, w: 1.1, d: 1.1 });
      }
    }
    if (r.type === "bathroom" && r.w > 6) {
      ...
      cyl(r.x + 1.3, 3.28, r.y + r.d - 0.8, 0.5, 0.27, m.white, scene, 0.6);
      box(r.x + 1.3, 5, r.y + r.d - 0.25, 1.65, 2.2, 0.045, m.glass);
      obstacles.push({ x: r.x + 0.35, z: r.y + r.d - 1.5, w: 1.9, d: 1.4 });
    }
  }
  return {
    mats,
